...
const WALKTHROUGH_STEPS: (Step & { id?: string })[] = [
  ...
  { id: "final-congrats", target: 'body', content: "🎉 Congratulations! You've mastered the basics! Your first quest was your MAIN QUEST (2x XP = 20 XP total!) and you just witnessed your companion evolve! You can add up to 3 more quests each day. Keep completing quests to grow your companion! 🚀", placement: "center", disableBeacon: true, hideBackButton: true, hideCloseButton: false },
];
