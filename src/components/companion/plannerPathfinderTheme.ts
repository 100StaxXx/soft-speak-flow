export const plannerPathfinderTheme = {
  shell:
    "relative overflow-hidden rounded-[2.25rem] border-[4px] border-[#4d2811] bg-[radial-gradient(circle_at_top_left,rgba(255,247,199,0.24),transparent_24%),radial-gradient(circle_at_bottom_right,rgba(254,151,54,0.18),transparent_28%),linear-gradient(180deg,#a23518_0%,#701d0d_62%,#4a1209_100%)] text-white shadow-[0_18px_0_#4d2811,0_34px_90px_-36px_rgba(38,12,5,0.62)]",
  shellGloss:
  ...
  shellBody: "relative flex min-h-0 flex-col p-4 sm:p-5",
  headerBar:
    "flex items-center gap-3 rounded-[1.8rem] border-[3px] border-[#4d2811] bg-[linear-gradient(180deg,rgba(255,251,239,0.2),rgba(255,206,105,0.14))] px-4 py-3 shadow-[0_8px_0_rgba(77,40,17,0.85)]",
  contentWell:
