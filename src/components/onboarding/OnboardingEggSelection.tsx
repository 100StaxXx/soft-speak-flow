...
const CHAMBER_BACKGROUND_EXPANDED_SRC = `${CHAMBER_ASSET_BASE}/choose-your-element-selection-screen-expanded.png`;
      ...
      <div className="onboarding-egg-selection__layout">
        ...
        >
          ...
          <img
            ...
            alt=""
            aria-hidden="true"
            className="onboarding-egg-chamber__underlay"
            data-testid="onboarding-egg-chamber-underlay"
            loading="eager"
          />
          <div className="onboarding-egg-chamber__underlay-tint" aria-hidden="true" />
          ...
          <div className="onboarding-egg-chamber__scene">
            <img
              ...
              data-testid="onboarding-egg-chamber-foreground"
              loading="eager"
            />
            <div className="onboarding-egg-chamber__foreground-vignette" aria-hidden="true" />
