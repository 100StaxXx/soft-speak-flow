...
const tierConfig = {
  ...
  silver: {
    gradient: "from-celestial-blue to-blue-500",
    shadow: "shadow-[0_0_15px_hsl(var(--celestial-blue)/0.3)]",
    icon: Award,
    glowColor: "blue",
  },
  gold: {
    gradient: "from-stardust-gold to-amber-500",
    shadow: "shadow-[0_0_15px_hsl(var(--stardust-gold)/0.4)]",
    icon: Trophy,
    glowColor: "gold",
  },
  platinum: {
    gradient: "from-purple-400 via-celestial-blue to-stardust-gold",
    shadow: "shadow-[0_0_20px_hsl(var(--stardust-gold)/0.5)]",
    icon: Crown,
    glowColor: "purple",
  },
};
