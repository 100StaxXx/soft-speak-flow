        ...
        <div className="bg-midnight border-2 border-charcoal rounded-2xl p-8 md:p-12 space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 pt-6">
            <Button
              ...
              className="flex-1 h-16 font-black uppercase tracking-wider bg-royal-purple hover:bg-royal-purple/90 text-pure-white shadow-[0_0_30px_rgba(137,81,204,0.5)] hover:shadow-[0_0_40px_rgba(137,81,204,0.7)] transition-all duration-300"
            >
              {isConfirming ? (
                <>Confirming...</>
              ) : (
