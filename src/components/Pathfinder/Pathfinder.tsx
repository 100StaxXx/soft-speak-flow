...
const parseDraftDeadline = (deadline: string | null): Date | undefined => {
  ...
  return parseISO(deadline.includes('T') ? deadline : `${deadline}T00:00:00`);
};
...
export function Pathfinder({
  ...
  }, [selectedHabits, isSubmittingCreate, isCreating, epicTitle, goalInput, epicWhy, targetDays, storyType, themeColor, schedule, onCreateEpic, success, trackInteraction, suggestions, userId]);
                    ...
                    <div key={s} className="flex items-center">
                      <div
                        className={cn(
                          ...
                          isActive
                            ? "border-[hsl(var(--celestial-blue)_/_0.46)] bg-[linear-gradient(180deg,color-mix(in_srgb,hsl(var(--celestial-blue))_12%,white)_0%,hsl(var(--celestial-blue)_/_0.2)_44%,hsl(var(--celestial-blue)_/_0.46)_100%)] text-[hsl(var(--deep-space))] shadow-[0_10px_20px_-16px_rgba(var(--primary-rgb),0.58),inset_0_1px_0_rgba(255,255,255,0.86)]"
                            : isComplete
