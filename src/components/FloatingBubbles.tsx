...
export const FloatingBubbles = ({ onBubbleClick, selectedValue }: FloatingBubblesProps) => {
  ...
  const getBubbleStyle = (value: string, type: "trigger" | "category") => {
    ...
    if (type === "trigger") {
      return "bg-white/90 text-warm-charcoal border-petal-pink/40 hover:border-blush-rose/60 hover:bg-white hover:shadow-md";
    }
    return "bg-gradient-to-br from-lavender-mist/70 to-petal-pink/50 text-warm-charcoal border-petal-pink/30 hover:from-lavender-mist hover:to-petal-pink hover:shadow-md";
  };
