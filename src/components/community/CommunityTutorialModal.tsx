        ...
        <DialogHeader>
          ...
          <DialogDescription className="space-y-4 pt-4 text-base">
            <p className="text-foreground">
              Connect with others on their growth journey! Create or join guilds 
            ...
            <div className="bg-accent/20 rounded-lg p-4 space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-foreground">
                  Create your own guild or join with an invite code
                </p>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-foreground">
                  Send shouts to encourage and motivate your guild
                </p>
              </div>
            </div>

            <p className="text-sm text-muted-foreground italic">
              Discover public guilds or create your own to get started!
            </p>
          </DialogDescription>
        </DialogHeader>
