...
export const BottomNav = memo(() => {
  ...
  const { companion, progressToNext, hasEvolutionReady } = useCompanion();
          ...
          {({ isActive }) => (
              <>
                <div className="relative">
                  ...
                  {hasEvolutionReady ? (
                    <Badge className="absolute -top-1 -right-1 h-4 w-4 p-0 flex items-center justify-center text-[9px] bg-emerald-500 text-white animate-pulse">
                      ✓
                    </Badge>
