...
export const PREMIUM_PLAN_NOTE =
  "Both monthly and yearly plans include the same Graceward Plus features and renew automatically until canceled.";
...
export const PREMIUM_SUBSCRIPTION_LEGAL_LINKS = {
  privacy: {
    ...
    inAppHref: "/privacy",
    publicHref: "https://graceward.app/privacy",
  },
  terms: {
    label: "Terms of Use",
    inAppHref: "/terms",
    publicHref: "https://graceward.app/terms",
  },
  appleEula: {
