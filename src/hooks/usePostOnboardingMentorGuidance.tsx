...
const TUTORIAL_DIALOGUE: Record<ActiveMentorSlug, Record<TutorialDialogueKey, MentorDialogueLine>> = {
  sage: {
    ...
    tap_hatch_companion: { text: "Scroll down and tap 'Hatch.'", support: "Your Companion is ready." },
  ...
  lyra: {
    ...
    tap_hatch_companion: { text: "Scroll down and tap 'Hatch.'", support: "Your Companion is ready to meet you." },
  ...
  icon: {
    ...
    tap_hatch_companion: { text: "Scroll down and tap 'Hatch.'", support: "You've earned the reveal." },
  ...
  charles: {
    ...
    tap_hatch_companion: { text: "Scroll down and tap 'Hatch.'", support: "You did enough. Shocking." },
  ...
  princess: {
    ...
    tap_hatch_companion: { text: "Scroll down and tap 'Hatch.'", support: "Your Companion is ready now." },
  ...
  operator: {
    ...
    tap_hatch_companion: { text: "Scroll down and tap 'Hatch.'", support: "Companion activation is ready." },
  ...
  rival: {
    ...
    tap_hatch_companion: { text: "Scroll down and tap 'Hatch.'", support: "You've earned one decent reveal." },
...
const usePostOnboardingMentorGuidanceController = (): PostOnboardingMentorGuidanceState => {
  ...
  const evolutionCompletionRecordedAt =
    sessionEvolutionCompletedAt ?? migratedProgress.evolutionCompletedAt;
  const isHatchRevealPending =
  ...
  useEffect(() => {
    ...
    if (currentStep.id === "hatch_companion") {
      const hasConfirmedHatch =
        ...
        !evolutionInFlight &&
        Boolean(evolutionCompletionRecordedAt) &&
        (hasRecordedEvolutionStart ||
          milestoneSet.has("tap_hatch_companion") ||
      ...
      if (hasConfirmedHatch) {
        void persistProgress({
          ...
          evolutionCompletedAt:
            evolutionCompletionRecordedAt ?? new Date().toISOString(),
        });
    ...
    if (currentStep.id === "hatch_companion") {
      ...
      listeners.push({
        ...
        handler: () => {
          ...
          setSessionEvolutionCompletedAt(completedAt);
          void persistProgress({
            evolutionInFlight: false,
            evolutionCompletedAt: completedAt,
          });
