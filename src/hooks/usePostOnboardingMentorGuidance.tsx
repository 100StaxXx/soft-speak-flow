...
const usePostOnboardingMentorGuidanceController = (): PostOnboardingMentorGuidanceState => {
  ...
  useEffect(() => {
    ...
    if (currentStep.id === "hatch_companion") {
      ...
      // listener flips sessionEvolutionInFlight to false when the user
      // dismisses the evolved-companion image, which is what releases this
      // gate. We use the session-only signal so a cold reopen mid-animation
      // (sessionEvolutionInFlight === null) does NOT strand the user.
