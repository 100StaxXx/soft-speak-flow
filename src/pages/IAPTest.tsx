...
const IAPTest = () => {
  ...
  // Refresh Apple StoreKit entitlement
  ...
  return (
    <div className="min-h-screen pb-nav-safe bg-background pb-8">
      ...
      <div className="sticky top-0 z-40 bg-background/95 backdrop-blur border-b border-border safe-area-top">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Apple StoreKit Development &amp; Debug Tools</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-4 space-y-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm">Apple StoreKit Entitlement</CardTitle>
          </CardHeader>
          <CardContent className="pt-0 space-y-3">
            <Button
