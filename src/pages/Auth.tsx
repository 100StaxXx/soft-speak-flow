...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-obsidian flex items-center justify-center p-4 overflow-hidden">
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleAuth} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-steel">Email</Label>
              <Input
                id="email"
                type="email"
                ...
                required
                className="bg-obsidian border-steel/20 text-pure-white"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="password" className="text-steel">Password</Label>
              <Input
                id="password"
                type="password"
                placeholder="••••••••"
            ...
            <Button
              type="submit"
              className="w-full bg-royal-gold hover:bg-royal-gold/90 text-obsidian font-bold"
              disabled={loading}
            >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-graphite px-2 text-steel">Or continue with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              ...
              className="bg-obsidian border-steel/20 text-pure-white hover:bg-steel/10"
            >
