...
const sections = [
  ...
  ["7. Scripture content", "Daily Scripture excerpts are read from reviewed app records. Your reading activity and saved responses may be stored like other usage and reflection data. The app does not infer or certify your religious status or spiritual standing."],
