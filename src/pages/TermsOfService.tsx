...
const sections = [
  ...
  ["2. What the service is", `${PRODUCT.name} provides Christian reflection, Scripture reading, prayer prompts, ready-made daily practices, reminders, and progress tools. It is a personal-support product—not a church, clergy relationship, sacrament, counseling service, medical service, or emergency service.`],
  ["3. Scripture and AI-generated material", "Reviewed Scripture excerpts identify their translation. Other reflections, prayers, practices, and responses may be generated or assisted by AI and can be incomplete or wrong. AI output is not divine revelation and does not speak for God. Verify important theological questions in Scripture and with a trusted pastor or qualified leader in your tradition."],
  ...
  ["9. Intellectual property", `${PRODUCT.name}, its original design, software, and non-user content are owned by ${PRODUCT.legalEntity} or its licensors. Bible translations and third-party material remain subject to their respective rights and notices.`],
