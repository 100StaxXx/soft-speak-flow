          ...
          <TabsContent value="epics" className="space-y-4 mt-6">
            ...
            <Card className="p-4 bg-gradient-to-br from-primary/5 to-purple-500/5">
              <div className="flex gap-3">
                <Button
                  onClick={() => window.open('https://discord.gg/yourserverinvite', '_blank')}
                  variant="outline"
                  className="flex-1 border-2 border-[#5865F2] text-[#5865F2] hover:bg-[#5865F2]/10"
                >
                  <svg className="w-4 h-4 mr-2" viewBox="0 0 71 55" fill="currentColor">
