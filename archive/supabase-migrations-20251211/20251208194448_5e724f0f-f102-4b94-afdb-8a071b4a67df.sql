-- Fix delete_user_account function with correct table names and all missing tables
...
BEGIN
  ...
  -- 30. Delete user daily horoscopes (FIXED: was user_horoscope)
  ...
  -- 40. Delete subscriptions (FIXED: was user_subscriptions)
