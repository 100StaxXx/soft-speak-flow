-- Harden promo redemption RPC and force PostgREST schema reload.
-- This removes dependency on optional profile columns and keeps access unlock source of truth
-- in promo_code_redemptions + check-apple-subscription.
...
-- Make sure PostgREST picks up function updates immediately.
