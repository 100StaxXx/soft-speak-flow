-- Include companion-images in the SQL-side account deletion fallback so
-- older or unregistered companion media does not keep account deletion stuck.
      ...
      EXECUTE
        'DELETE FROM storage.objects
         WHERE owner = $1
            OR owner_id = $2
            OR (
              bucket_id IN (''quest-attachments'', ''mentors-avatars'', ''journey-paths'', ''companion-images'')
