-- Secure delete_user_account function with caller identity verification
-- Users can only delete their own account, or service_role can delete any account
...
-- Restrict function access - revoke from public, grant only to authenticated and service_role
