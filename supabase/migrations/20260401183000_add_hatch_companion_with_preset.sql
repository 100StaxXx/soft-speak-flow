...
REVOKE EXECUTE ON FUNCTION public.hatch_companion_with_preset(uuid, text, text, text, text, text, text, text, integer) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.hatch_companion_with_preset(uuid, text, text, text, text, text, text, text, integer) TO authenticated;
