-- Complete rewrite of delete_user_account function
-- Removes 4 non-existent tables and adds 17 missing tables
-- Properly ordered by foreign key dependencies
...
BEGIN
  ...
  -- 5. Delete adversary essences (depends on user_companion)
  DELETE FROM public.adversary_essences WHERE user_id = p_user_id;
  
  -- 6. Delete astral encounters (depends on user_companion)
  DELETE FROM public.astral_encounters WHERE user_id = p_user_id;
  
  -- 7. Delete xp events (depends on user_companion)
  ...
  -- 9. Delete challenge progress (depends on user_challenges)
  ...
  -- 11. Delete habit completions (depends on habits)
  DELETE FROM public.habit_completions WHERE user_id = p_user_id;
  
  -- 12. Delete epic habits (depends on habits and epics)
  ...
  -- 16. Delete guild shouts (sender or recipient)
  ...
  -- 29. Delete user achievement stats
  DELETE FROM public.user_achievement_stats WHERE user_id = p_user_id;
