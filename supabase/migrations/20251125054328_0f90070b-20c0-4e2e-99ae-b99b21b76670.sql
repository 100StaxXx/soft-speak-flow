-- Drop and recreate the companion creation function with all required fields
DROP FUNCTION IF EXISTS create_companion_if_not_exists(uuid, text, text, text, text, text, text, text, text);
...
BEGIN
  ...
  RETURN QUERY SELECT 
    ...
    v_companion.body,
    v_companion.soul,
    v_companion.bond_level,
    v_companion.resilience,
