-- Make delete_user_account fully remove the auth user so the app can rely on
-- a single RPC instead of requiring an edge function for final account removal.
