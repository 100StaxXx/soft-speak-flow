...
const MENTOR_VOICES: Record<string, string> = {
  'atlas': 'JBFqnCBsd6RMkjVDRZzb',   // George - authoritative
  'darius': 'rWyjfFeMZ6PxkHqD3wGC',  // Brian - intense
  'eli': 'iP95p4xoKVk53GoZ742B',     // Chris - wise
  'nova': 'onwK4e9ZLuTAKqWW03F9',    // Daniel - visionary
  'sienna': 'XB0fDUnXU5powFXDhCwa',  // Charlotte - compassionate
  'lumi': 'EXAVITQu4vr4xnSDxMaL',    // Sarah - tranquil
  'kai': 'N2lVS1w4EtoT3dr4eOWO',     // Callum - high energy
  'stryker': 'pNInz6obpgDQGcFmaJgB', // Rich - powerful
  'solace': 'pFZP5JQG7iQjIQuC4Bku',  // Lily - gentle
};
