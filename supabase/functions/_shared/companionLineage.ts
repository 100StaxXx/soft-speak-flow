...
const buildArtDirection = (): string[] => [
  ...
  "transparent background with alpha where supported",
  "no scenic or environmental backdrop, floor, frame, border, card, or solid background",
  "aura, glow, and particles may surround the companion but should sit over transparency",
...
export const buildEggFromStage1Prompt = (profile: VisualIdentityProfile): string => {
  return [
    ...
    "- Render as a transparent-background cutout with no scenic backdrop, floor, frame, card, or solid background",
