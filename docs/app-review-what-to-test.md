...
- **Start a subscription**: Sign in, open Profile → Account → Subscription Details, choose a plan, and tap **Subscribe** to trigger the native StoreKit sheet (e.g., cosmiq_premium_monthly). After purchase, the status should show Cosmiq Premium as active.
