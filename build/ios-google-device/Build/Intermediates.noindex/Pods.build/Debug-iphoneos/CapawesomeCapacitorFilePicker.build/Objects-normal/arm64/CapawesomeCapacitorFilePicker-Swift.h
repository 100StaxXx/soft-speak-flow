...
#ifndef CAPAWESOMECAPACITORFILEPICKER_SWIFT_H
#define CAPAWESOMECAPACITORFILEPICKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CapawesomeCapacitorFilePicker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC29CapawesomeCapacitorFilePicker15CopyFileOptions")
@interface CopyFileOptions : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC29CapawesomeCapacitorFilePicker10FilePicker")
...
@class NSURL;
@interface FilePicker (SWIFT_EXTENSION(CapawesomeCapacitorFilePicker)) <UIDocumentPickerDelegate>
...
@interface FilePicker (SWIFT_EXTENSION(CapawesomeCapacitorFilePicker)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate>
