...
#ifndef CAPACITORCOMMUNITYCONTACTS_SWIFT_H
#define CAPACITORCOMMUNITYCONTACTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CapacitorCommunityContacts",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC26CapacitorCommunityContacts8Contacts")
...
@interface ContactsPlugin : CAPPlugin <CNContactPickerDelegate>
