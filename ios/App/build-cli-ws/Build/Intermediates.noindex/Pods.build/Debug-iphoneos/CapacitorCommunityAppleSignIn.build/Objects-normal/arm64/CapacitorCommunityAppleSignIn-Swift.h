...
#ifndef CAPACITORCOMMUNITYAPPLESIGNIN_SWIFT_H
#define CAPACITORCOMMUNITYAPPLESIGNIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CapacitorCommunityAppleSignIn",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface SignInWithApple (SWIFT_EXTENSION(CapacitorCommunityAppleSignIn)) <ASAuthorizationControllerDelegate>
