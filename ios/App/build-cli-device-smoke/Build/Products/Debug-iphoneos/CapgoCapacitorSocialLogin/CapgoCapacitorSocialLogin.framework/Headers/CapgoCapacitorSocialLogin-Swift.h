...
#ifndef CAPGOCAPACITORSOCIALLOGIN_SWIFT_H
#define CAPGOCAPACITORSOCIALLOGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CapgoCapacitorSocialLogin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("SocialLoginPlugin")
@interface SocialLoginPlugin : CAPPlugin <CAPBridgedPlugin>
